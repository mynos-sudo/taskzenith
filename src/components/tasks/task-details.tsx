      ...
      <DialogHeader>
        ...
        <DialogDescription>
            <div className="flex items-center gap-4 text-xs text-muted-foreground mt-1">
                ...
                <span>Due on {task.dueDate ? format(new Date(task.dueDate), "MMM d, yyyy") : 'N/A'}</span>
            </div>
        </DialogDescription>
      </DialogHeader>
        ...
        <div className="py-4 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              {task.comments.length === 0 && <p className="text-sm text-muted-foreground text-center py-4">No comments yet. Start the conversation!</p>}
